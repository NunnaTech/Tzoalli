  ...
  visitService.GetAllNextVisits(token)
    ...
    .then((response) => {
      ...
      if (response.data.data.length === 0) {
        ...
        <h1 class="font-bold text-2xl drop-shadow-sm  text-center text-gray-400">No cuentas con nuevas visitas</h1>
        `
      } else {
            ...
            <!-- Modal de confirmación -->
              ...
              <div class="modal modal-bottom sm:modal-middle">
                <div class="modal-box">
                  ...
                  <button class="btn bg-[#25AC5B] border-none w-full mt-2" id="completeBtn" onclick='complete(${item.id},${i});' style="background-color: #25ac5b; color: white">
